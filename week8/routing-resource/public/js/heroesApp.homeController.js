angular.module('HeroesApp')
	.controller('homeController', ['$scope', '$http', 'justiceFactory', homeController])

function homeController ($scope, $http, justiceFactory){
	$scope.greeting = 'Welcome to Heroes of AJAX'

	$scope.createHero = function(){

		var heroThang = new justiceFactory.Hero($scope.newHero)
		heroThang.$save(function(data){
